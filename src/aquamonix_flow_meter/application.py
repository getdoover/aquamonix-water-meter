...
from .app_ui import AquamonixFlowMeterUI
from .app_state import AquamonixFlowMeterState

log = logging.getLogger()

class AquamonixFlowMeterApplication(Application):
    config: AquamonixFlowMeterConfig  # not necessary, but helps your IDE provide autocomplete!

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        self.started: float = time.time()
        self.ui: AquamonixFlowMeterUI = None
        self.state: AquamonixFlowMeterState = None

    async def setup(self):
        self.ui = AquamonixFlowMeterUI()
        self.state = AquamonixFlowMeterState()
